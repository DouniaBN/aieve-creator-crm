...
const BrandDeals = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 mb-6">
        <p className="text-gray-600">Track and manage your brand partnerships</p>
        <button
